...
const BANNER: Banner = {
  ...
  imgDesktop: "/assets/aboutus/ourhistory/about-hero1-2.png",
  imgTablet:  "/assets/aboutus/ourhistory/about-hero1-2.png",
  imgMobile:  "/assets/aboutus/ourhistory/about-hero1-2.png",
};
...
export default function Hero1() {
  ...
  return (
    <section id="heroSlider3" className="relative w-screen overflow-hidden">
