...
const ITEMS = [
  { label: "Slider1", targetId: "heroSlider1" },
  { label: "Slider2", targetId: "heroSlider2" },
  { label: "Slider3", targetId: "heroSlider3" },
  { label: "Slider4", targetId: "heroSlider5" },
  { label: "Slider5", targetId: "heroSlider4" }
];
